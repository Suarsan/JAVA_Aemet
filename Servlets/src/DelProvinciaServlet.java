...
/**
 * Clase encargada de gestionar la peticion de borrado de una provincia, y realiza la petición a la bbdd
 * @author Javier Suarez Sanchez
 *
 */
public class DelProvinciaServlet extends HttpServlet{
	...
	throws ServletException, IOException {
		...
		int codProv = Integer.parseInt(request.getParameter("id"));
		System.out.println("borrandoProvincia_"+bbdd.getProvincia(codProv).getNombre());
		
		//Borra la provincia
		ok = bbdd.delProvincia(codProv);

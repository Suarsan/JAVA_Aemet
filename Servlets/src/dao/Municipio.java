...
public class Municipio implements paa.municipios.IMunicipio{
	...
	/**
	 * Constructor de la clase dado un nombre, una provincia, una altitud y un c&oacutedigo
	...
	public int getAltitud(){
		return altitud;}
	/**
	 * Devuelve el c&oacutedigo postal del municipio
	...
	public void setAltitud(int altitud){
		this.altitud = altitud;}
	/**
	 * Actualiza el c&oacutedigo postal del municipio
	...
	public void setProvincia(IProvincia provincia){
		this.provincia = provincia;}
	/**
	 * Devuelve un string con el c&oacutedigo y el nombre del municipio*/
